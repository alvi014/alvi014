...
<!-- BANNER -->
<img src=".github/assets/banner.svg" alt="Álvaro Víctor Zamora" width="100%"/>

<br/>

<!-- TYPING ANIMATION -->
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=00FF64&center=true&vCenter=true&width=600&lines=.NET+Backend+Developer+%F0%9F%9A%80;Clean+Architecture+Enthusiast+%F0%9F%8F%97%EF%B8%8F;Coffee-Driven+%E2%98%95+%7C+CrossFit+Addict+%F0%9F%8F%8B%EF%B8%8F;Building+scalable+systems%2C+one+API+at+a+time)](https://git.io/typing-svg)
...
```typescript
const alvaro: Developer = {
  name:       "Álvaro Víctor Zamora",
  role:       ".NET Backend Developer & Software Architect",
  location:   "Costa Rica 🇨🇷",
  focus:      ["RESTful APIs", "Clean Architecture", "Distributed Systems"],
  currentlyBuilding: "CoffeeLocator — location-based API with DDD + .NET 8",
  
  offTheKeyboard: {
    fuel:     "☕ Strong black coffee, no sugar",
    sport:    "🏋️ CrossFit | ⚽ Soccer | 🏊 Swimming | 🏃 Running",
    vibes:    "🎮 Retro games & pixel art (Mario Bros forever)",
    core:     "👨‍👩‍👧 Family first, always",
  },

  philosophy: "Code is like coffee — strong, well-filtered, and best shared.",
};
```
...
<img width="100%" src="https://github-readme-activity-graph.vercel.app/graph?username=alvi014&theme=react-dark&bg_color=0d1117&color=00ff64&line=00ff64&point=ffffff&area=true&hide_border=true" />
...
| 🏆 | Achievement | Details |
|:---:|:---|:---|
| 🏗️ | **Architecture First** | Learning to build modular software |
| ☕ | **Coffee-Driven Dev** | Proven correlation between coffee cups and commits |
| 🎮 | **Retro at Heart** | Mario Bros fan since cartridge era |
| 🏋️ | **Code & Lift** | CrossFit PRs and Git PRs — both count |
| 🚀 | **API Craftsman** | Obsessed with clean, documented, scalable REST APIs |
| 🌍 | **Costa Rica 🇨🇷** | Building from the tropics |
...
> Best reached via: LinkedIn or WhatsApp
> Timezone: UTC-6 (Costa Rica 🇨🇷)
```
...
*`// Last updated: 2026 | Built with ☕ + 💻 + Clean Architecture`*
